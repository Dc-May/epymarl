...
class MADDPGCoopLearner:
    ...
    def train(self, batch: EpisodeBatch, t_env: int, episode_num: int):
        ...
        # TODO: March 16 2022; Cooperative environment does not need to expand the reward to all dimensions
        ...
        # TODO: this is where the rewards are going to have to be changed.
