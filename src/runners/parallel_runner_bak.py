...
import torch as th
import os
def test(input_pipe, ouutput_pipe):
    x = 1
    return
...
class ParallelRunner:
    ...
    def __init__(self, args, logger, external_launch=False):
        ...
        if not external_launch:
            ...
            # test(self.parent_conns[0], self.worker_conns[0])
            ...
            # just have the things here already
            self.parent_conns = args.parent_conns
            self.worker_conns = args.worker_conns
